              ...
              {historyLedgers.length > 0 && (
                <div className="sidebar-section" style={{ marginTop: "24px" }}>
                  ...
                  {historyLedgers.map((ledger) => (
                    <div
                      key={ledger.id}
                      className={`product-card history-card ${selectedLedgerId === ledger.id ? "selected" : ""}`}
                      onClick={() => setSelectedLedgerId(ledger.id)}
                    >
                      <div className="card-header">
                        <span className="card-marker">{ledger.ledgerName}</span>
                      ...
                      <div className="card-status-badge">Fully Sold</div>
                    </div>
                  ))}
                </div>
              )}
            ...
            {viewMode === "colors" ? (
              <div>
                  ...
                  <div className="sell-panel-container">
                    ...
                    <div className="sell-panel-body">
                      <div className="sell-panel-inputs">
                        ...
                        >
                          {sellingInProgress ? "Saving..." : "Sell Selected"}
                        </button>
                      </div>
                ...
                {exports.filter((e) => e.ledgerId === selectedLedger.id)
                  .length > 0 && (
                  <div className="rf-container ledger-history-section">
                    ...
                    <div className="history-table-wrapper">
                      <table className="history-table">
                        ...
                        <tbody>
                          {exports
                            .filter((e) => e.ledgerId === selectedLedger.id)
                            .map((sale) => (
                              <tr key={sale.id}>
                                <td>
